...
For example if the input number is 2, and the input list is [1,2,3,1,2,1,2,3], you take [1,2,3,1,2], drop the next [1,2] since this would lead to 1 and 2 being 
...
def delete_nth(order,max_e):
    ...
    # The loop iterates over the 'order' and each 'num' inside of it and checks if the 'num' in question has appeared less times than the 'max_e" input by the user
    # If so, the num is 'append' to the 'new_order' list.
    for num in order:
