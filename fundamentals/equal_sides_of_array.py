...
def find_even_index(arr):
    ...
    # The loop iterate over the array with the 'enumerate()' function.
    # If the sum of the left side of the array is equal to the remainder (which would be the right side), then return 'i' as the answer, if not, add it to the
    # left total and loop again until there is a match. If no matches, the loop returns -1.
